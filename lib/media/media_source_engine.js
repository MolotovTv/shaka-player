...
shaka.media.MediaSourceEngine = class {
  ...
  /**
   * @return {boolean|undefined} True if the MediaSource is in an "open"
   * state, or if the object has been destroyed.
   */
  opened() {
    if (this.reloadingMediaSource_) {
      return undefined;
    }
    return this.mediaSource_ ? this.mediaSource_.readyState == 'open' : true;
  }

  /**
   * @return {boolean|undefined} True if the MediaSource is in an "ended"
   * state, or if the object has been destroyed.
   */
  ended() {
    if (this.reloadingMediaSource_) {
  ...
  /**
   * @return {boolean|undefined} True if the MediaSource is in an "closed"
   * state, or if the object has been destroyed.
   */
  closed() {
    if (this.reloadingMediaSource_) {
